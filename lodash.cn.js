...
(function () {
  ...
  /** 检测自由变量 `global`，用来获取Node.js的全局对象：global 对象 */
  var freeGlobal =
    typeof global == "object" && global && global.Object === Object && global;

  /** 检测自由变量 `self`，用来获取浏览器环境的全局对象：window对象 */
  var freeSelf =
  ...
  var runInContext = function runInContext(context) {
    ...
    /**
     * 获取标签的基础实现，不包含对有问题环境的回退处理
     *
     * @private
     * @param {*} value 要获取标签的对象
     * @returns {string} 返回标签
     */
    ...
    /**
     * `_.isDate` 的基础实现，不包含 Node.js 的优化部分。
     *
     * @private
     * @param {*} value The value to check.
    ...
    /**
     * `_.isRegExp` 的基础实现，不包含 Node.js 的优化部分
     *
     * @private
     * @param {*} value The value to check.
    ...
    /**
     * baseGetTag 的特殊版本，会忽略 Symbol.toStringTag 的值
     *
     * @private
     * @param {*} value 查询的值
    ...
    function isArrayLike(value) {
      // 1. 非空
      // 2. length 是整数
      // 3. 不是函数（函数的 length 是只读的，表示函数定义时的形参个数）
    ...
    function isBoolean(value) {
      // 前两种场景为基础类型的布尔值
      // 后者是对象类型的布尔值，其值不是 undefined 或 null 的任何对象（包括其值为 false 的布尔对象）在传递给条件语句时都将计算为 true。
      return (
        value === true ||
        value === false ||
    ...
    function isFinite(value) {
      // 不先做 typeof 检查的话，以下情况会产生意外结果
      // nativeIsFinite('123')     // true，因为会进行隐式类型转换
     ...
     * @category Lang
     * @param {*} value 要检查的值
     * @returns {boolean} 如果 value 是一个函数则返回 true，否则返回 false
     * @example
     *
     * _.isFunction(_);
     * // => true
    ...
    function isObject(value) {
      // 获取参数的类型；
      // 可能返回："string"、"number"、"boolean"、"undefined"、"object"、"function"、"symbol"
      var type = typeof value;
    ...
    /**
     * 检查 value 是否是类对象。如果一个值不是 null 且 typeof 结果是 "object"，那么这个值就是类对象。
     *
     * @static
     * @memberOf _
     * @since 4.0.0
    ...
    function isNaN(value) {
      ...
      // `NaN` 原始值是唯一一个不等于自身的值。
      // 首先执行`toStringTag` 检查，以避免在 IE 中某些 ActiveX 对象可能产生的错误。
      // 例如，
    ...
    function isSymbol(value) {
      // 分别处理 Symbol 和 Symbol 对象 Object(Symbol('foo'))，
      // 对象场景，没有找到原因，基础值和对象保持处理一致性
      return (
        typeof value == "symbol" ||
